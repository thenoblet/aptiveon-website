    ...
    <div className="page-main">
      <div className="page-wrap">
        ...
        <PageHero
          title={
            <>
              Send the <span className="mark">constraint</span>, not the
              wishlist.
            </>
          }
        ...
        <section className="contact-section" id="form">
          <div className="sec-head">
            ...
            <span className="sec-meta">one form, one inbox</span>
          </div>
          ...
          <div className="formgrid">
            ...
            <aside className="form-r">
              ...
              <h4>Shape</h4>
              <p>
                What's the system at a high level? Who uses it? What does it
                do for them?
              </p>
              <h4>Data</h4>
              ...
              <h4>Constraint</h4>
              <p>
                What's the hard part? Time, integration, accuracy, trust, cost
                — name it.
              </p>
              <h4>Stakes</h4>
          ...
          <div className="channels">
            <div>
              ...
              <p>
                If you'd rather skip the form, the inbox is read by the
                founding team.
              </p>
            ...
            <div>
              ...
              <p>
                Apply directly with a short note about what you've built and
                want to build next.
              </p>
